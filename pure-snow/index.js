const SNOW_WRAPPER_SELECTOR = '#snowWrapper';
...
function getSnowAttributes() {
  const snowWrapper = document.body.querySelector(SNOW_WRAPPER_SELECTOR);
...
function showSnow(value) {
  if (value) {
    document.body.querySelector(SNOW_WRAPPER_SELECTOR).style.display = 'block';
  } else {
    document.body.querySelector(SNOW_WRAPPER_SELECTOR).style.display = 'none';
  }
}
